...
const config: ClientConfig = {
  realm: getEnv('REACT_APP_OIDC_REALM'),
  url: getEnv('REACT_APP_OIDC_URL'),
  authority: getEnv('REACT_APP_OIDC_URL'),
  clientId: getEnv('REACT_APP_OIDC_CLIENT_ID'),
  callbackPath: getEnv('REACT_APP_OIDC_CALLBACK_PATH'),
  logoutPath: getEnv('REACT_APP_OIDC_LOGOUT_PATH'),
